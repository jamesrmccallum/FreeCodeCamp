...
function makeFriendlyDates(arr) {
    ...
    //Compare both dates
    var sameDate = year1.join('') === year2.join('');
    var gapOverYear = new Date(year1[0] + 1, year1[1], year1[2]) <= endYear;
    var currentYearStart = new Date().getFullYear() === year1[0];
    var sameMonth = year1[0] === year2[0] && year1[1] === year2[1];
